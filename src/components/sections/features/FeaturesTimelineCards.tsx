      ...
      <div className="flex flex-col w-content-width mx-auto gap-8">
        ...
        <Transition className="flex flex-col gap-5">
          <div className="relative aspect-square md:aspect-10/4 overflow-hidden card rounded">
            <Transition key={activeIndex} transitionType="fade" className="absolute inset-3 xl:inset-4 2xl:inset-5 overflow-hidden rounded">
          ...
          <div className={cls(
            ...
            {items.map((item, index) => (
              <div
                ...
                className="flex flex-col justify-between gap-3 xl:gap-4 2xl:gap-5 p-3 xl:p-4 2xl:p-5 card rounded transition-opacity duration-300 opacity-50 data-[active=true]:opacity-100 cursor-pointer data-[active=true]:cursor-default hover:opacity-75 data-[active=true]:hover:opacity-100"
              >
